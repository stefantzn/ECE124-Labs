...
SIGNAL \TWOONEMUX1|out_0[0]~0_combout\ : std_logic;
SIGNAL \sw[1]~input_o\ : std_logic;
SIGNAL \sw[5]~input_o\ : std_logic;
SIGNAL \FULLADDER|FA1|FULL_ADDER_CARRY_OUTPUT~0_combout\ : std_logic;
SIGNAL \sw[6]~input_o\ : std_logic;
SIGNAL \sw[2]~input_o\ : std_logic;
SIGNAL \TWOONEMUX1|out_0[2]~2_combout\ : std_logic;
SIGNAL \sw[7]~input_o\ : std_logic;
SIGNAL \sw[3]~input_o\ : std_logic;
SIGNAL \FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0_combout\ : std_logic;
SIGNAL \TWOONEMUX1|out_0[3]~3_combout\ : std_logic;
SIGNAL \FULLADDER|FA1|FULL_ADDER_SUM_OUTPUT~combout\ : std_logic;
SIGNAL \TWOONEMUX1|out_0[1]~1_combout\ : std_logic;
SIGNAL \SEVENSEGMENT1|Mux5~0_combout\ : std_logic;
SIGNAL \TWOONEMUX2|out_0[2]~3_combout\ : std_logic;
SIGNAL \TWOONEMUX2|out_0[3]~4_combout\ : std_logic;
SIGNAL \TWOONEMUX2|out_0[0]~0_combout\ : std_logic;
SIGNAL \TWOONEMUX2|out_0[0]~1_combout\ : std_logic;
SIGNAL \TWOONEMUX2|out_0[1]~2_combout\ : std_logic;
SIGNAL \SEVENSEGMENT2|Mux5~0_combout\ : std_logic;
SIGNAL \clkin_50~input_o\ : std_logic;
SIGNAL \clkin_50~inputclkctrl_outclk\ : std_logic;
SIGNAL \SEVENSEGMENTMUX|clk_proc:COUNT[0]~0_combout\ : std_logic;
SIGNAL \SEVENSEGMENTMUX|clk_proc:COUNT[0]~q\ : std_logic;
...
SIGNAL \LOGICALPROCESSOR|Mux3~0_combout\ : std_logic;
SIGNAL \LOGICALPROCESSOR|Mux2~0_combout\ : std_logic;
SIGNAL \LOGICALPROCESSOR|Mux1~0_combout\ : std_logic;
SIGNAL \LOGICALPROCESSOR|Mux0~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \LOGICALPROCESSOR|Mux3~0_combout\,
	devoe => ww_devoe,
	o => \leds[0]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \LOGICALPROCESSOR|Mux2~0_combout\,
	devoe => ww_devoe,
	o => \leds[1]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \LOGICALPROCESSOR|Mux1~0_combout\,
	devoe => ww_devoe,
	o => \leds[2]~output_o\);
...
-- pragma translate_on
PORT MAP (
	i => \LOGICALPROCESSOR|Mux0~0_combout\,
	devoe => ww_devoe,
	o => \leds[3]~output_o\);
...
\TWOONEMUX1|out_0[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX1|out_0[0]~0_combout\ = \sw[0]~input_o\ $ (((\sw[4]~input_o\ & !\pb_n[2]~input_o\)))
...
PORT MAP (
	...
	combout => \TWOONEMUX1|out_0[0]~0_combout\);
...
\FULLADDER|FA1|FULL_ADDER_CARRY_OUTPUT~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \FULLADDER|FA1|FULL_ADDER_CARRY_OUTPUT~0_combout\ = (\sw[1]~input_o\ & ((\sw[5]~input_o\) # ((\sw[0]~input_o\ & \sw[4]~input_o\)))) # (!\sw[1]~input_o\ & (\sw[0]~input_o\ & (\sw[4]~input_o\ & \sw[5]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[4]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \FULLADDER|FA1|FULL_ADDER_CARRY_OUTPUT~0_combout\);
...
\TWOONEMUX1|out_0[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX1|out_0[2]~2_combout\ = \sw[2]~input_o\ $ (((!\pb_n[2]~input_o\ & (\FULLADDER|FA1|FULL_ADDER_CARRY_OUTPUT~0_combout\ $ (\sw[6]~input_o\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \FULLADDER|FA1|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \TWOONEMUX1|out_0[2]~2_combout\);
...
\FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0_combout\ = (\FULLADDER|FA1|FULL_ADDER_CARRY_OUTPUT~0_combout\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))) # (!\FULLADDER|FA1|FULL_ADDER_CARRY_OUTPUT~0_combout\ & (\sw[6]~input_o\ & \sw[2]~input_o\))
...
PORT MAP (
	...
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0_combout\);

-- Location: LCCOMB_X9_Y7_N0
\TWOONEMUX1|out_0[3]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX1|out_0[3]~3_combout\ = \sw[3]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[7]~input_o\ $ (\FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0_combout\)))))
...
PORT MAP (
	...
	datab => \pb_n[2]~input_o\,
	datac => \sw[3]~input_o\,
	datad => \FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	combout => \TWOONEMUX1|out_0[3]~3_combout\);

-- Location: LCCOMB_X9_Y7_N22
\FULLADDER|FA1|FULL_ADDER_SUM_OUTPUT\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \FULLADDER|FA1|FULL_ADDER_SUM_OUTPUT~combout\ = \sw[1]~input_o\ $ (\sw[5]~input_o\ $ (((\sw[0]~input_o\ & \sw[4]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[4]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \FULLADDER|FA1|FULL_ADDER_SUM_OUTPUT~combout\);

-- Location: LCCOMB_X9_Y7_N28
\TWOONEMUX1|out_0[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX1|out_0[1]~1_combout\ = (\pb_n[2]~input_o\ & ((\sw[1]~input_o\))) # (!\pb_n[2]~input_o\ & (\FULLADDER|FA1|FULL_ADDER_SUM_OUTPUT~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \FULLADDER|FA1|FULL_ADDER_SUM_OUTPUT~combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[1]~input_o\,
	combout => \TWOONEMUX1|out_0[1]~1_combout\);

-- Location: LCCOMB_X11_Y7_N2
\SEVENSEGMENT1|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEVENSEGMENT1|Mux5~0_combout\ = (\TWOONEMUX1|out_0[3]~3_combout\ & ((\TWOONEMUX1|out_0[0]~0_combout\ & ((\TWOONEMUX1|out_0[1]~1_combout\))) # (!\TWOONEMUX1|out_0[0]~0_combout\ & (\TWOONEMUX1|out_0[2]~2_combout\)))) # (!\TWOONEMUX1|out_0[3]~3_combout\ & 
-- (\TWOONEMUX1|out_0[2]~2_combout\ & (\TWOONEMUX1|out_0[0]~0_combout\ $ (\TWOONEMUX1|out_0[1]~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \TWOONEMUX1|out_0[0]~0_combout\,
	datab => \TWOONEMUX1|out_0[2]~2_combout\,
	datac => \TWOONEMUX1|out_0[3]~3_combout\,
	datad => \TWOONEMUX1|out_0[1]~1_combout\,
	combout => \SEVENSEGMENT1|Mux5~0_combout\);

-- Location: LCCOMB_X9_Y7_N8
\TWOONEMUX2|out_0[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX2|out_0[2]~3_combout\ = (\sw[6]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[6]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \TWOONEMUX2|out_0[2]~3_combout\);

-- Location: LCCOMB_X9_Y7_N6
\TWOONEMUX2|out_0[3]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX2|out_0[3]~4_combout\ = (\sw[7]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[7]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \TWOONEMUX2|out_0[3]~4_combout\);

-- Location: LCCOMB_X9_Y7_N2
\TWOONEMUX2|out_0[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX2|out_0[0]~0_combout\ = (\sw[7]~input_o\ & ((\sw[3]~input_o\) # (\FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0_combout\))) # (!\sw[7]~input_o\ & (\sw[3]~input_o\ & \FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0_combout\))
...
PORT MAP (
	...
	datac => \sw[3]~input_o\,
	datad => \FULLADDER|FA2|FULL_ADDER_CARRY_OUTPUT~0_combout\,
	combout => \TWOONEMUX2|out_0[0]~0_combout\);

-- Location: LCCOMB_X9_Y7_N16
\TWOONEMUX2|out_0[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX2|out_0[0]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[4]~input_o\)) # (!\pb_n[2]~input_o\ & ((\TWOONEMUX2|out_0[0]~0_combout\)))
...
PORT MAP (
	datab => \pb_n[2]~input_o\,
	datac => \sw[4]~input_o\,
	datad => \TWOONEMUX2|out_0[0]~0_combout\,
	combout => \TWOONEMUX2|out_0[0]~1_combout\);

-- Location: LCCOMB_X9_Y7_N14
\TWOONEMUX2|out_0[1]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \TWOONEMUX2|out_0[1]~2_combout\ = (\pb_n[2]~input_o\ & \sw[5]~input_o\)
...
PORT MAP (
	datab => \pb_n[2]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \TWOONEMUX2|out_0[1]~2_combout\);

-- Location: LCCOMB_X10_Y7_N4
\SEVENSEGMENT2|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEVENSEGMENT2|Mux5~0_combout\ = (\TWOONEMUX2|out_0[3]~4_combout\ & ((\TWOONEMUX2|out_0[0]~1_combout\ & ((\TWOONEMUX2|out_0[1]~2_combout\))) # (!\TWOONEMUX2|out_0[0]~1_combout\ & (\TWOONEMUX2|out_0[2]~3_combout\)))) # (!\TWOONEMUX2|out_0[3]~4_combout\ & 
-- (\TWOONEMUX2|out_0[2]~3_combout\ & (\TWOONEMUX2|out_0[0]~1_combout\ $ (\TWOONEMUX2|out_0[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \TWOONEMUX2|out_0[2]~3_combout\,
	datab => \TWOONEMUX2|out_0[3]~4_combout\,
	datac => \TWOONEMUX2|out_0[0]~1_combout\,
	datad => \TWOONEMUX2|out_0[1]~2_combout\,
...
\SEVENSEGMENTMUX|clk_proc:COUNT[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEVENSEGMENTMUX|clk_proc:COUNT[0]~0_combout\ = !\SEVENSEGMENTMUX|clk_proc:COUNT[0]~q\
...
-- pragma translate_on
PORT MAP (
	datac => \SEVENSEGMENTMUX|clk_proc:COUNT[0]~q\,
	combout => \SEVENSEGMENTMUX|clk_proc:COUNT[0]~0_combout\);

-- Location: FF_X11_Y7_N5
\SEVENSEGMENTMUX|clk_proc:COUNT[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	d => \SEVENSEGMENTMUX|clk_proc:COUNT[0]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \SEVENSEGMENTMUX|clk_proc:COUNT[0]~q\);

-- Location: LCCOMB_X11_Y7_N8
\SEVENSEGMENTMUX|clk_proc:COUNT[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEVENSEGMENTMUX|clk_proc:COUNT[1]~1_combout\ = (\SEVENSEGMENTMUX|clk_proc:COUNT[0]~q\ & (\SEVENSEGMENTMUX|clk_proc:COUNT[1]~q\ $ (VCC))) # (!\SEVENSEGMENTMUX|clk_proc:COUNT[0]~q\ & (\SEVENSEGMENTMUX|clk_proc:COUNT[1]~q\ & VCC))
-- \SEVENSEGMENTMUX|clk_proc:COUNT[1]~2\ = CARRY((\SEVENSEGMENTMUX|clk_proc:COUNT[0]~q\ & \SEVENSEGMENTMUX|clk_proc:COUNT[1]~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \SEVENSEGMENTMUX|clk_proc:COUNT[0]~q\,
...
PORT MAP (
	clk => \clkin_50~inputclkctrl_outclk\,
	d => \SEVENSEGMENTMUX|clk_proc:COUNT[1]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \clkin_50~inputclkctrl_outclk\,
	d => \SEVENSEGMENTMUX|clk_proc:COUNT[2]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \clkin_50~inputclkctrl_outclk\,
	d => \SEVENSEGMENTMUX|clk_proc:COUNT[3]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datab => \SEVENSEGMENTMUX|clk_proc:COUNT[4]~q\,
	datad => VCC,
...
-- pragma translate_on
PORT MAP (
	dataa => \SEVENSEGMENTMUX|clk_proc:COUNT[8]~q\,
	datad => VCC,
...
-- Equation(s):
-- \SEVENSEGMENTMUX|clk_proc:COUNT[10]~1_combout\ = \SEVENSEGMENTMUX|clk_proc:COUNT[10]~q\ $ (\SEVENSEGMENTMUX|clk_proc:COUNT[9]~2\)
...
-- pragma translate_on
PORT MAP (
	dataa => \SEVENSEGMENTMUX|clk_proc:COUNT[10]~q\,
...
-- pragma translate_on
PORT MAP (
	dataa => \SEVENSEGMENT1|Mux5~0_combout\,
...
-- Equation(s):
-- \SEVENSEGMENT1|Mux1~0_combout\ = (\TWOONEMUX1|out_0[2]~2_combout\ & ((\TWOONEMUX1|out_0[1]~1_combout\ & (\TWOONEMUX1|out_0[0]~0_combout\ & !\TWOONEMUX1|out_0[3]~3_combout\)) # (!\TWOONEMUX1|out_0[1]~1_combout\ & ((\TWOONEMUX1|out_0[3]~3_combout\))))) # 
-- (!\TWOONEMUX1|out_0[2]~2_combout\ & (!\TWOONEMUX1|out_0[3]~3_combout\ & ((\TWOONEMUX1|out_0[0]~0_combout\) # (\TWOONEMUX1|out_0[1]~1_combout\))))
...
PORT MAP (
	dataa => \TWOONEMUX1|out_0[0]~0_combout\,
	datab => \TWOONEMUX1|out_0[2]~2_combout\,
	datac => \TWOONEMUX1|out_0[1]~1_combout\,
	datad => \TWOONEMUX1|out_0[3]~3_combout\,
	combout => \SEVENSEGMENT1|Mux1~0_combout\);

-- Location: LCCOMB_X10_Y7_N30
\SEVENSEGMENT2|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEVENSEGMENT2|Mux1~0_combout\ = (\TWOONEMUX2|out_0[2]~3_combout\ & ((\TWOONEMUX2|out_0[3]~4_combout\ & ((!\TWOONEMUX2|out_0[1]~2_combout\))) # (!\TWOONEMUX2|out_0[3]~4_combout\ & (\TWOONEMUX2|out_0[0]~1_combout\ & \TWOONEMUX2|out_0[1]~2_combout\)))) # 
-- (!\TWOONEMUX2|out_0[2]~3_combout\ & (!\TWOONEMUX2|out_0[3]~4_combout\ & ((\TWOONEMUX2|out_0[0]~1_combout\) # (\TWOONEMUX2|out_0[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \SEVENSEGMENT1|Mux1~0_combout\,
	datac => \SEVENSEGMENT2|Mux1~0_combout\,
	datad => \SEVENSEGMENTMUX|clk_proc:COUNT[10]~q\,
...
-- Equation(s):
-- \SEVENSEGMENT1|Mux0~0_combout\ = (\TWOONEMUX1|out_0[3]~3_combout\) # ((\TWOONEMUX1|out_0[2]~2_combout\ & ((!\TWOONEMUX1|out_0[1]~1_combout\) # (!\TWOONEMUX1|out_0[0]~0_combout\))) # (!\TWOONEMUX1|out_0[2]~2_combout\ & ((\TWOONEMUX1|out_0[1]~1_combout\))))
...
-- Equation(s):
-- \SEVENSEGMENT2|Mux0~0_combout\ = (\TWOONEMUX2|out_0[3]~4_combout\) # ((\TWOONEMUX2|out_0[2]~3_combout\ & ((!\TWOONEMUX2|out_0[1]~2_combout\) # (!\TWOONEMUX2|out_0[0]~1_combout\))) # (!\TWOONEMUX2|out_0[2]~3_combout\ & ((\TWOONEMUX2|out_0[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \SEVENSEGMENT1|Mux0~0_combout\,
	datac => \SEVENSEGMENT2|Mux0~0_combout\,
	datad => \SEVENSEGMENTMUX|clk_proc:COUNT[10]~q\,
...
\LOGICALPROCESSOR|Mux3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \LOGICALPROCESSOR|Mux3~0_combout\ = (\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & (\sw[4]~input_o\ & \sw[0]~input_o\)) # (!\pb_n[0]~input_o\ & ((\sw[4]~input_o\) # (\sw[0]~input_o\))))) # (!\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[4]~input_o\ $ 
-- (!\sw[0]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[4]~input_o\,
	datad => \sw[0]~input_o\,
	combout => \LOGICALPROCESSOR|Mux3~0_combout\);

-- Location: LCCOMB_X9_Y7_N30
\LOGICALPROCESSOR|Mux2~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \LOGICALPROCESSOR|Mux2~0_combout\ = (\pb_n[1]~input_o\ & ((\sw[1]~input_o\ & ((\sw[5]~input_o\) # (!\pb_n[0]~input_o\))) # (!\sw[1]~input_o\ & (!\pb_n[0]~input_o\ & \sw[5]~input_o\)))) # (!\pb_n[1]~input_o\ & (\sw[1]~input_o\ $ (\pb_n[0]~input_o\ $ 
-- (!\sw[5]~input_o\))))
...
PORT MAP (
	...
	datad => \sw[5]~input_o\,
	combout => \LOGICALPROCESSOR|Mux2~0_combout\);

-- Location: LCCOMB_X9_Y7_N20
\LOGICALPROCESSOR|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \LOGICALPROCESSOR|Mux1~0_combout\ = (\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & (\sw[6]~input_o\ & \sw[2]~input_o\)) # (!\pb_n[0]~input_o\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))))) # (!\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[6]~input_o\ $ 
-- (!\sw[2]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \LOGICALPROCESSOR|Mux1~0_combout\);

-- Location: LCCOMB_X9_Y7_N18
\LOGICALPROCESSOR|Mux0~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \LOGICALPROCESSOR|Mux0~0_combout\ = (\pb_n[1]~input_o\ & ((\pb_n[0]~input_o\ & (\sw[3]~input_o\ & \sw[7]~input_o\)) # (!\pb_n[0]~input_o\ & ((\sw[3]~input_o\) # (\sw[7]~input_o\))))) # (!\pb_n[1]~input_o\ & (\pb_n[0]~input_o\ $ (\sw[3]~input_o\ $ 
-- (!\sw[7]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[3]~input_o\,
	datad => \sw[7]~input_o\,
	combout => \LOGICALPROCESSOR|Mux0~0_combout\);

-- Location: LCCOMB_X10_Y7_N20
\SEVENSEGMENT1|Mux6~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \SEVENSEGMENT1|Mux6~0_combout\ = (\TWOONEMUX1|out_0[2]~2_combout\ & (!\TWOONEMUX1|out_0[1]~1_combout\ & ((\TWOONEMUX1|out_0[3]~3_combout\) # (!\TWOONEMUX1|out_0[0]~0_combout\)))) # (!\TWOONEMUX1|out_0[2]~2_combout\ & (\TWOONEMUX1|out_0[0]~0_combout\ & 
-- (\TWOONEMUX1|out_0[1]~1_combout\ $ (!\TWOONEMUX1|out_0[3]~3_combout\))))
...
-- Equation(s):
-- \SEVENSEGMENT2|Mux6~0_combout\ = (\TWOONEMUX2|out_0[2]~3_combout\ & (!\TWOONEMUX2|out_0[1]~2_combout\ & ((\TWOONEMUX2|out_0[3]~4_combout\) # (!\TWOONEMUX2|out_0[0]~1_combout\)))) # (!\TWOONEMUX2|out_0[2]~3_combout\ & (\TWOONEMUX2|out_0[0]~1_combout\ & 
-- (\TWOONEMUX2|out_0[3]~4_combout\ $ (!\TWOONEMUX2|out_0[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \SEVENSEGMENT1|Mux6~0_combout\,
	datac => \SEVENSEGMENT2|Mux6~0_combout\,
	datad => \SEVENSEGMENTMUX|clk_proc:COUNT[10]~q\,
...
-- Equation(s):
-- \SEVENSEGMENT1|Mux4~0_combout\ = (\TWOONEMUX1|out_0[2]~2_combout\ & (\TWOONEMUX1|out_0[3]~3_combout\ & ((\TWOONEMUX1|out_0[1]~1_combout\) # (!\TWOONEMUX1|out_0[0]~0_combout\)))) # (!\TWOONEMUX1|out_0[2]~2_combout\ & (!\TWOONEMUX1|out_0[0]~0_combout\ & 
-- (\TWOONEMUX1|out_0[1]~1_combout\ & !\TWOONEMUX1|out_0[3]~3_combout\)))
...
-- Equation(s):
-- \SEVENSEGMENT2|Mux4~0_combout\ = (\TWOONEMUX2|out_0[2]~3_combout\ & (\TWOONEMUX2|out_0[3]~4_combout\ & ((\TWOONEMUX2|out_0[1]~2_combout\) # (!\TWOONEMUX2|out_0[0]~1_combout\)))) # (!\TWOONEMUX2|out_0[2]~3_combout\ & (!\TWOONEMUX2|out_0[3]~4_combout\ & 
-- (!\TWOONEMUX2|out_0[0]~1_combout\ & \TWOONEMUX2|out_0[1]~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \SEVENSEGMENT1|Mux4~0_combout\,
	datab => \SEVENSEGMENT2|Mux4~0_combout\,
	datad => \SEVENSEGMENTMUX|clk_proc:COUNT[10]~q\,
...
-- Equation(s):
-- \SEVENSEGMENT2|Mux3~0_combout\ = (\TWOONEMUX2|out_0[1]~2_combout\ & ((\TWOONEMUX2|out_0[2]~3_combout\ & ((\TWOONEMUX2|out_0[0]~1_combout\))) # (!\TWOONEMUX2|out_0[2]~3_combout\ & (\TWOONEMUX2|out_0[3]~4_combout\ & !\TWOONEMUX2|out_0[0]~1_combout\)))) # 
-- (!\TWOONEMUX2|out_0[1]~2_combout\ & (!\TWOONEMUX2|out_0[3]~4_combout\ & (\TWOONEMUX2|out_0[2]~3_combout\ $ (\TWOONEMUX2|out_0[0]~1_combout\))))
...
-- Equation(s):
-- \SEVENSEGMENT1|Mux3~0_combout\ = (\TWOONEMUX1|out_0[1]~1_combout\ & ((\TWOONEMUX1|out_0[0]~0_combout\ & (\TWOONEMUX1|out_0[2]~2_combout\)) # (!\TWOONEMUX1|out_0[0]~0_combout\ & (!\TWOONEMUX1|out_0[2]~2_combout\ & \TWOONEMUX1|out_0[3]~3_combout\)))) # 
-- (!\TWOONEMUX1|out_0[1]~1_combout\ & (!\TWOONEMUX1|out_0[3]~3_combout\ & (\TWOONEMUX1|out_0[0]~0_combout\ $ (\TWOONEMUX1|out_0[2]~2_combout\))))
...
-- Equation(s):
-- \SEVENSEGMENT2|Mux2~0_combout\ = (\TWOONEMUX2|out_0[1]~2_combout\ & (((!\TWOONEMUX2|out_0[3]~4_combout\ & \TWOONEMUX2|out_0[0]~1_combout\)))) # (!\TWOONEMUX2|out_0[1]~2_combout\ & ((\TWOONEMUX2|out_0[2]~3_combout\ & (!\TWOONEMUX2|out_0[3]~4_combout\)) # 
-- (!\TWOONEMUX2|out_0[2]~3_combout\ & ((\TWOONEMUX2|out_0[0]~1_combout\)))))
...
-- Equation(s):
-- \SEVENSEGMENT1|Mux2~0_combout\ = (\TWOONEMUX1|out_0[1]~1_combout\ & (\TWOONEMUX1|out_0[0]~0_combout\ & ((!\TWOONEMUX1|out_0[3]~3_combout\)))) # (!\TWOONEMUX1|out_0[1]~1_combout\ & ((\TWOONEMUX1|out_0[2]~2_combout\ & ((!\TWOONEMUX1|out_0[3]~3_combout\))) # 
-- (!\TWOONEMUX1|out_0[2]~2_combout\ & (\TWOONEMUX1|out_0[0]~0_combout\))))
